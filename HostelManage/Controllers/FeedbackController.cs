...
namespace HostelManage.Controllers
{
    ...
    public class FeedbackController : ControllerBase
    {
        ...
        {
            var result = await _service.AddFeedback(dto);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetFeedbackCount()
        {
            var count = await _service.GetFeedbackCount();
            return Ok(new { Count = count });
        }
        ...
        public async Task<IActionResult> GetAllFeedbacks()
        {
            var data = await _service.GetAllFeedbacks();
            return Ok(data);
        }
        ...
        public async Task<IActionResult> GetAverageRating(int hostelId)
        {
            var result = await _service.GetAverageRating(hostelId);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> GetFeedbackByHostelId(int hostelId)
        {
            var data = await _service.GetFeedbackByHostelId(hostelId);
            return Ok(data);
        }
        ...
        public async Task<IActionResult> DeleteFeedback(int feedbackId, [FromQuery] int hostelId)
        {
            var result = await _service.DeleteFeedback(feedbackId, hostelId);
